...
export default function SuccessSignUp({ logIn, setLogIn }: { logIn: boolean, setLogIn: Function }): JSX.Element {
                            ...
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-500">
                                        Account was created successfully, log-in into your account
